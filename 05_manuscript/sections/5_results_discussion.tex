...
The PINN reduces RMSE from \SI{7.21}{K} (the best classical correlation, Basu et al.)
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/fig02_correlation_parity}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.65\linewidth]{figures/fig03_pinn_parity}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.75\linewidth]{figures/fig04_ensemble_errorbars}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/fig05_std_by_category}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{figures/fig06_std_vs_qflux}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{figures/fig07_physics_trends_composite}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.75\linewidth]{figures/fig08_inverse_rc_vs_Ra}
...
fluid-by-$q''$ confounding. The mechanism is, however, more than
statistical. The Hsu activation band depends on the group
$8\,C_2\,\sigma\,T_{\mathrm{sat}}/(\rho_v\,h_{fg})$
(\cref{eq:hsu_rc_range}), which collapses sharply in moving from
atmospheric water (high $\sigma$, high $h_{fg}$, low $\rho_v$) to
high-pressure refrigerants. Atmospheric water therefore requires
macro-cavities of $1$--$\SI{15}{\micro\meter}$ formed by surface
roughening, so increased $R_a$ correlates with larger active radii.
Refrigerants, in contrast, activate sub-micron cavities even on
polished surfaces, and the residual variation in $R_a$ across the
JABARDO refrigerant subset is dominated by the heater-material
choice. Water data come from low-$q''$, near-atmospheric operation
on rougher, lower-density surfaces. R-134a data come from
high-pressure, high-$q''$ operation on smoother, higher-density
surfaces. The pooled trend is thus a textbook example of a
thermodynamic scaling effect masquerading as a geometric correlation.
Stratified mean radii are
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.85\linewidth]{figures/fig09_inverse_rc_by_category}
