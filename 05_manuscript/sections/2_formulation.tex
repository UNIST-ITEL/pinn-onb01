...
% -----------------------------------------------------------------------------
\subsection{Non-dimensional scales}\label{subsec:nondim}%
\label{subsec:dimless}
% -----------------------------------------------------------------------------
...
length $L_c$, the latent-heat temperature scale
$\Delta T_{\mathrm{ref}}$, and a Zuber-type heat-flux scale
$q_{\mathrm{ref}}$ are defined by
%
\begin{align}
L_c &\;=\; \sqrt{\,\frac{\sigma}{g\,(\rho_l - \rho_v)}\,}, \label{eq:Lc} \\
\Delta T_{\mathrm{ref}} &\;=\; \frac{h_{fg}}{c_{p,l}}, \label{eq:dT_ref} \\
q_{\mathrm{ref}} &\;=\; h_{fg}\,\rho_v^{1/2}\,\bigl[\sigma\,g\,(\rho_l - \rho_v)\bigr]^{1/4}, \label{eq:q_ref}
\end{align}
%
