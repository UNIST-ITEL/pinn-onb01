...
| 항목 | 결정 |
|---|---|
| 공개 시점 | 코드: **이미 public** (2026-05-18, IJHMT 제출 후) / Code+Data DOI: **수락 후** Release 시점 |
| GitHub repo | `https://github.com/UNIST-ITEL/pinn-onb01` (org 계정, **현재 public**) |
...
| # | 작업 | 담당 | 상태 |
|---|---|---|---|
| 0-1 | UNIST-ITEL GitHub organization 계정 생성 (없으면) | Jaeseon Lee | ✅ (2026-05-18) |
| 0-2 | Zenodo 계정 생성 + ORCID 연동 (0000-0003-1996-6086) | Jaeseon Lee | ✅ (2026-05-18) |
| 0-3 | Zenodo $\leftrightarrow$ GitHub 통합 설정 (Zenodo Settings → GitHub) | Jaeseon Lee | ✅ (2026-05-18, webhook 200 OK) |
...
| ~~1-2~~ | ~~GitHub repo 공개 전환 (private → public)~~ — **2026-05-18 이미 public** | (해당 없음) |
...
| 위험 | 대응 |
|---|---|
| Reviewer가 게재 전 데이터/코드 검토 요구 (편집자 권한으로 가능) | 현재 public이므로 repo URL 그대로 안내. Zenodo dataset record는 publish 전까지 draft (DOI reserved) 상태로 유지 |
