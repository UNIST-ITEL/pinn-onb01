...
cooling \cite{KANDLIKAR2004, LEEMUDAWAR2008}, the thermal-margin budget of
nuclear fuel assemblies, and the design of compact refrigerant evaporators
\cite{SAITOH2007}. Predicting ONB accurately therefore has
...
\cite{SATOMATSUMURA1964}, and the mechanistic model of Basu et al. \cite{BASU2002}, together with later
incipience and subcooled-boiling treatments \cite{FROST1967, THOM1965}---each
...
kelvin even on canonical water data. Even the most recent dimensionless
correlation, distilled from a broad experimental data review by Conde-Fontenla
et al.\ \cite{CONDEFONTENLA2024}, remains confined to a limited window and does
not unify the confinement and nonlinear property variations of the full range
\cite{HARIRCHIAN2009}. Modern applications, however, span a
...
low-GWP refrigerants \cite{LOWGWPREVIEW2023}---so a predictor that remains
accurate and physically consistent \emph{across} that space is needed.

Data-driven and physics-informed neural networks (PINNs) offer a route to such
breadth \cite{CAI2021, JIN2021}, and recent studies apply them to two-phase and
boiling heat transfer \cite{JALILI2024a, VIDHYARTHI2025}. Most data-driven
boiling models, however, target the critical heat flux or the boiling
heat-transfer coefficient; the incipience point itself remains comparatively
underexplored. Moreover, two obstacles recur in boiling. First, ONB data are scarce and
...
cavity spectrum) \cite{JAFARI2016, VONTAS2021}. The present work extends that
framework to subcooled forced convection. The central question is whether the
pool-boiling surface representation can be \emph{reused}---in the spirit of
transfer-learned physics-informed models \cite{PRANTIKOS2023, JALILI2024b}---and
combined with a flow representation to predict ONB over the much larger
forced-convection parameter space.
...
\item A curated, openly released dataset of 351 ONB points harmonised from ten
