...
wall superheat with a test RMSE of \SI{1.84}{K} ($R^2=0.77$) and heat flux with
\SI{144}{kW\,m^{-2}} ($R^2=0.74$), $1.9$--$2.6\times$ and over an order of
...
($\dTonb$ RMSE \SI{1.72}{K}) and provides epistemic uncertainty; an honest
